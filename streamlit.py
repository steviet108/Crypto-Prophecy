...
option = st.sidebar.selectbox("Dashboards", ('Top 100 Cryptocurrencies by Market Cap', 'Coin Analysis', 'Google Trends', ' Tweet Counts', 'Charts', 'Cycle Analysis'), 1)
...
# This is the Charts option on dashboard dropdown.
